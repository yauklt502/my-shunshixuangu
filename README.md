...
- [formulas/qingkong_tdx_xuangu.txt](formulas/qingkong_tdx_xuangu.txt)：通达信收敛版（仅 B1：急跌+回踩均线）
- [formulas/qingkong_tdx_b1_only.txt](formulas/qingkong_tdx_b1_only.txt)：B1 无 CAPITAL 版
